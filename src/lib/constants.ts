...
export const CATEGORIES: Category[] = [
  {
    ...
    icon: Heart,
    description: 'Unspoken desires and secret attractions.',
  },
  { name: 'Power Play', icon: Swords, description: 'Exploring dynamics of control and surrender.' },
  {
    name: 'Emotional Depths',
    icon: Drama,
    description: 'Deep feelings, vulnerabilities, and bonds.',
  },
  {
    name: 'Mind Games',
    icon: BrainCircuit,
    description: 'Intellectual and psychological connections.',
  },
  {
    name: 'Shared Pasts',
    icon: Moon,
    description: 'Reflecting on memories and experiences together.',
  },
  {
    name: 'Future Dreams',
    icon: Sun,
    description: 'Aspirations, hopes, and plans for the future.',
  },
...
export const SPICY_LEVELS: SpicyLevel[] = [
  {
    name: 'Mild',
    description: 'Gentle questions to warm things up. Perfect for getting started.',
    icon: Wind,
  },
  {
    name: 'Medium',
    description: 'Getting a little more personal. Explores deeper feelings and thoughts.',
    icon: Sunrise,
  },
  {
    name: 'Hot',
    description: 'Turning up the heat. Questions that are daring and provocative.',
    icon: Flame,
  },
  {
    name: 'Extra-Hot',
    description: 'For the bold and adventurous. Pushes boundaries and explores fantasies.',
    icon: Zap,
  },
];
