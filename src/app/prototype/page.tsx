...
const spicyLevels = [
  { name: 'Mild', icon: Wind, description: 'A gentle breeze. Flirty, fun, and easy.' },
  {
    name: 'Medium',
    icon: Sunrise,
    description: 'Warming up. Getting personal and a little daring.',
  },
          ...
          <AnimatePresence>
            {selectedLevel && (
              ...
              >
                <Button
                  size="lg"
                  className="text-lg font-bold px-12 py-8 rounded-full shadow-lg shadow-primary/30 transform hover:scale-105 transition-transform duration-300"
                >
